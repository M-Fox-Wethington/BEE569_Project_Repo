...
#Extract all OCCUPIED locations (indicated by value of 1)
...
cat("
  ...
  #Occupancy priors
  b0.occ ~ dnorm(0, 1/2.71)  #occupancy prob when area is 0 (if area is standardized this is prob of occ with the average area)
...
save(Mod2_ZIP_6400 , file="Model2_ZIP_6400_DifferentPriors1.RData")
#load("Mod2_ZIP_6400")
...
#Set up a dataframe with the MCMC summary information
Plot.Dat <- as.data.frame(cbind(Lambdas, Lambda_CI.1,  Lambda_CI.2, Psi, Psi_CI.1, Psi_CI.2, Areas))




#Display Occupancy against Area (standardized) 
ggplot(data = Plot.Dat, mapping = aes(x = Areas))+
